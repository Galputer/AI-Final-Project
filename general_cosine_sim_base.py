...
# For the Formula : 
HELPFUL_VOTES_MULTIPLIER = 0.005
TOTAL_VOTES_MULTIPLIER = 0.001
...
def filter_pickle(r_df, keywords):
...
def generate_top_ten(keywords = 'math science book text', semantic = 'pos', filename_list = ['2005','2004','2003','2002','2001','2000']):
    ...
    if semantic == 'neg':
        grouped_df = grouped_df[grouped_df['sentiment-score'] < -0.3]
    elif semantic == 'pos':
        grouped_df = grouped_df[grouped_df['sentiment-score'] > 0.3]
